...
<div id="content">
<div id="main_content">
<div style="text-align:center"><h2>게시글 정보 수정</h2></div>
<div style="text-align:center"><h5>개별 게시글 정보를 수정합니다.</h5></div>
<table class="table">
	...
	<tr >
		...
		<td> <textarea name="bContent" id="bContent" rows="10"  cols="100">${content_view.bContent }</textarea> </td>
